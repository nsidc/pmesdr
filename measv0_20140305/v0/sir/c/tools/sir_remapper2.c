...
int main(int argc, char **argv)
{
  ...
  int   Dset = 0, use_standard_region = 0;
  int   nDarg = 10;
  ...
  if (argc < 2 || Nfiles == 0) {
    ...
    fprintf(stdout,"        read from local file 'regiondef1.dat' with pixel size factor\n");
    fprintf(stdout,"        pix size: 0=SSM/I,1=ERS,2=SASS/NSCAT/QSCAT_Egg,3=QSCAT_slice\n");
    fprintf(stdout,"        (roughly 0=17.8, 1=8.9, 2=4.45, 3=2.225, 4=1.1125 km/pix)\n");
