...
#define CETB_NCATTS_TB_MISSING_VALUE 60000
#define CETB_NCATTS_STOKES_MISSING_VALUE 60000
...
#define CETB_NCATTS_STOKES_SCALED_MIN ( (CETB_NCATTS_STOKES_MIN * CETB_NCATTS_STOKES_SCALE_FACTOR) + CETB_STOKES_ADD_OFFSET )
#define CETB_NCATTS_TB_SCALED_MAX ( CETB_NCATTS_TB_MAX * CETB_NCATTS_TB_SCALE_FACTOR )
#define CETB_NCATTS_STOKES_SCALED_MAX ( (CETB_NCATTS_STOKES_MAX * CETB_NCATTS_STOKES_SCALE_FACTOR) + CETB_STOKES_ADD_OFFSET )
...
#define CETB_NCATTS_TB_STDDEV_MISSING_VALUE ( (NC_MAX_USHORT) - 1 )
