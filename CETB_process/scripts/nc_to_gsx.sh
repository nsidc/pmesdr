...
do
    basen=`basename $file`
    echo "/projects/moha2290/miniconda3/envs/gsx/bin/gsx $gsx_type $file /scratch/summit/moha2290/${src}_GSX/GSX_$basen" >> /scratch/summit/moha2290/${src}_scripts/gsx_lb_list_summit
done
