...
if [ "$1" == "-h" ] || [ "$#" -ne 5 ] ; then
    ...
    echo "  It makes 4 different files, for 19-22 NS, 19-22 T, "
    echo "  37-91 NS nad 37-91 T.  Usually you can combine them into"
    echo "  1 file afterwards and run all 'makes' together."
    echo "Arguments:"
