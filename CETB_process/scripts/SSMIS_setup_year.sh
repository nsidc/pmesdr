...
#
date
for FILE in `find /scratch/summit/${USER}/${top_level}/${SRC}_make/*.${YEAR}.*`
do
    echo "$BINDIR/meas_meta_setup $FILE /scratch/summit/${USER}/${top_level}/${SRC}_setup" >> /scratch/summit/${USER}/${top_level}/${SRC}_scripts/${SRC}_setup_list_${YEAR}
done
#
date
