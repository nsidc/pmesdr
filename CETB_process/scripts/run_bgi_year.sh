...
src=$2
envpath=$3
file=/scratch/summit/${USER}/${src}_scripts/${src}_bgi_list_${year}
source ${envpath}/summit_set_pmesdr_environment.sh
ml impi
ml loadbalance
ml
date
mpirun -genv I_MPI_FABRICS=shm:tmi -genv I_MPI_TMI_PROVIDER=psm2 -n 10 lb ${file}
date
