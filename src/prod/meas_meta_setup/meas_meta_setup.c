 ...
 *
 * returns : the fileID of the opened .meta file, or NULL in case of error
 *
 */
 ...
 *  noffset : int **, ptr array to each region
 ...
 *
 * returns : inverse of the map_scale, (1/meters)
 *
 */
