...
void setUp( void ) {
  ...
  TEST_ASSERT_EQUAL_STRING( "./test/NSIDC-0630-EASE2_T25km-F13_SSMI-1991153-19H-A-SIR-CSU-v1.1.nc",
			    cetb->filename );
...
void test_cetb_dimensions( void ) {
  ...
  status = nc_open( "./test/NSIDC-0630-EASE2_T25km-F13_SSMI-1991153-19H-A-SIR-CSU-v1.1.nc",
