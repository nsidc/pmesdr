...
void test_cetb_N_parameters( void ) {
  ...
  strcpy( test_filename, "./test/NSIDC-0630_EASE2_N3.125km.F13_SSMI.1991001.19H.M.SIR.CSU.v0.1.nc" );
...
void test_cetb_S_parameters( void ) {
  ...
  strcpy( test_filename, "./test/NSIDC-0630_EASE2_S6.25km.F13_SSMI.1991001.19H.M.SIR.CSU.v0.1.nc" );
...
void test_cetb_T_parameters( void ) {
  ...
  strcpy( test_filename, "./test/NSIDC-0630_EASE2_T12.5km.F13_SSMI.1991001.19H.A.SIR.CSU.v0.1.nc" );
