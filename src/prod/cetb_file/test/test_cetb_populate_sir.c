...
void setUp( void ) {
  ...
  TEST_ASSERT_EQUAL_STRING( "./test/NSIDC-0630-EASE2_N25km-F13_SSMI-1991001-19H-M-SIR-CSU-v1.1.nc",
			    cetb->filename );
...
void test_cetb_populate_sir_parameters( void ) {
  ...
  status = nc_open( "./test/NSIDC-0630-EASE2_N25km-F13_SSMI-1991001-19H-M-SIR-CSU-v1.1.nc",
