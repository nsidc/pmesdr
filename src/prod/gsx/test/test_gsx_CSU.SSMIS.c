...
{
  const char *fn = "b.nc";
  //  const char *fn = "GSX_CSU_SSMIS_FCDR_V01R00_F16_D20061031_S2235_E0017_R15670.nc";
  //  const char *fn = "GSX_CSU_SSMI_FCDR_V01R00_F13_D19970303_S1857_E2039_R10029.nc";
...
void test_gsx_dim_measurements_loc1 ( void ) { 
  ...
  case CETB_AMSRE: 
    ...
    break; 
  case CETB_SSMIS: 
    TEST_ASSERT_TRUE( gsx->measurements[loc] == 90 ); 
    break; 
  } 
  gsx_close( gsx ); 
} 
...
void test_gsx_dim_measurements_loc3 ( void ) { 
  ...
  case CETB_AMSRE: 
    ...
    break; 
  case CETB_SSMIS: 
    TEST_ASSERT_TRUE( gsx->measurements[loc] == 180 ); 
    break; 
  } 
  gsx_close( gsx ); 
} 
...
void test_gsx_fill_values_loc2 ( void ) { 
  ...
  if ( ( NULL != gsx ) && ( gsx->scans[i] != 0 ) ) { 
    ...
    TEST_ASSERT_TRUE( -9999.0 == gsx->fill_eia[i] ); 
    TEST_ASSERT_TRUE( -9999.0 == gsx->fill_eaz[i] ); 
    if ( gsx->short_sensor != CETB_SSMIS )
      TEST_ASSERT_TRUE( -1.e+30 == gsx->fill_scantime[i] ); 
  } 
  gsx_close( gsx ); 
} 
