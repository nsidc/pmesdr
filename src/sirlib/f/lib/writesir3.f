...
c     Revised by D.G. Long  12 Mar 2014 + added EASE2
c
c
c inputs:
...
c	if (iopt.eq.11.or.iopt.eq.12.or.iopt.eq.13) then ! EASE1 grid
...
c					!   8 = EASE2 north equal area grid
c					!   9 = EASE2 south equal area grid
c					!  10 = EASE2 cylindrical grid
c					!  11 = EASE1 north equal area grid
c					!  12 = EASE1 south equal area grid
c					!  13 = EASE1 cylindrical grid
