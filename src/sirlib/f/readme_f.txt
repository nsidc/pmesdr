...
The program sir_extractregion creates SIR files consisting of
subregions of another SIR file.  The program fsir_dump converts a 
SIR file to an ASCII file with pixel values and locations listed.  
Given a SIR file, the program fsir_locmap creates two SIR files 
which contain pixel values which are the  latitude and longitudes of 
the pixels.
